...
class SonicDeviceDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    def available(self) -> bool:
        ...
        return self.last_update_success and self._device_information["radio_connection"] == "connected"
    ...
    async def _update_device(self, *_) -> None:
        ...
        self._telemetry_information = await self.api_client.sonic.async_sonic_telemetry_by_id(
            self._sonic_device_id
        )
